...
const GameCard = ({ title, rank, tier, peakRank, winRate, hoursPlayed, image }: GameCardProps) => {
  return (
      ...
      <CardContent className="p-5 space-y-6">
        <div className="flex items-end justify-between">
          ...
          <div className="text-right space-y-1">
            ...
            <p className="text-sm font-bold text-slate-300">{peakRank}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 pt-2">
          ...
          <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-800/50 border border-slate-700/30">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-white">{hoursPlayed}</p>
            </div>
          </div>
        </div>
      </CardContent>
