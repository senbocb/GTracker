...
import { Search, UserPlus, UserCheck, UserX, MessageSquare, User, Shield } from 'lucide-react';
...
const Social = () => {
  ...
  useEffect(() => {
    // Mock data for now, would be Supabase queries
    setFriends([
      { id: '1', username: 'Ghost_Operator', status: 'online', level: 24 },
      { id: '2', username: 'Viper_Squad', status: 'offline', level: 18 }
    ]);
    setRequests([
    ...
    <AppLayout>
      <main className="max-w-6xl mx-auto p-6 md:p-10">
        <div className="mb-10">
          ...
          <p className="text-slate-400 font-medium">Connect with other operators and manage your network.</p>
        </div>
